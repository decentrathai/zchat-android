...
internal fun ScanZashiAddressScreen(args: ScanArgs) {
    ...
    // For RESTORE_SEED flow, we don't need a synchronizer (wallet doesn't exist yet)
    // For other flows, show loading indicator until synchronizer is ready
    if (synchronizer == null && args.flow != ScanFlow.RESTORE_SEED) {
