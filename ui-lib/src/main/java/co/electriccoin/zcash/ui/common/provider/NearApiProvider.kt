...
// Current Zodl/NEAR-Intents 1Click partner token (partner_id=zodl, exp 2027-04-01). Replaces the old
// 'electriccoin' token (kid 2025-04-23, exp 2026-08-14) — which would have stopped all swaps in Aug 2026.
// NOTE the "Bearer " prefix: the header is set verbatim from this const; the old value was missing it.
