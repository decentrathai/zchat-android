package co.electriccoin.zcash.ui.screen.home.initiating
...
@Composable
fun WalletInitiatingMessage(
    contentPadding: PaddingValues,
    state: WalletInitiatingMessageState,
    ...
    HomeMessageWrapper(
        ...
        title = {
            Text(
                text = stringResource(R.string.home_message_initiating_title, state.progress),
            )
        },
        subtitle = {
            Text(
                text = stringResource(R.string.home_message_initiating_subtitle),
            )
        },
        end = null
    )
...
@Immutable
class WalletInitiatingMessageState(
    val progress: Float,
    val onClick: () -> Unit
) : HomeMessageState
