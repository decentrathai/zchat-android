...
internal data class LightPrimaryButtonColors(
    override val containerColor: Color = Color(0xFF2563EB),  // Blue-600
    override val disabledContainerColor: Color = Color(0xFF93C5FD),  // Blue-300
    override val shadowColor: Color = Color(0xFF1D4ED8),  // Blue-700
    override val disabledShadowColor: Color = Color(0xFFBFDBFE),  // Blue-200
    override val textColor: Color = Color(0xFFFFFFFF),
    override val disabledTextColor: Color = Color(0xFFFFFFFF),
    override val strokeColor: Color = Color(0xFF2563EB),  // Blue-600
    override val disabledStrokeColor: Color = Color(0xFF93C5FD),  // Blue-300
    override val shadowStrokeColor: Color = Color(0xFF1D4ED8),  // Blue-700
    override val shadowDisabledStrokeColor: Color = Color(0xFF93C5FD),  // Blue-300
) : ButtonColors
...
internal data class DarkPrimaryButtonColors(
    override val containerColor: Color = Color(0xFF2563EB),  // Blue-600
    override val disabledContainerColor: Color = Color(0xFF1E40AF),  // Blue-800
    override val shadowColor: Color = Color(0xFF1D4ED8),  // Blue-700
    override val disabledShadowColor: Color = Color(0xFF1E3A8A),  // Blue-900
    override val textColor: Color = Color(0xFFFFFFFF),
    override val disabledTextColor: Color = Color(0xFFBFDBFE),  // Blue-200
    override val strokeColor: Color = Color(0xFF2563EB),  // Blue-600
    override val disabledStrokeColor: Color = Color(0xFF1E40AF),  // Blue-800
    override val shadowStrokeColor: Color = Color(0xFF1D4ED8),  // Blue-700
    override val shadowDisabledStrokeColor: Color = Color(0xFF1E40AF),  // Blue-800
) : ButtonColors
